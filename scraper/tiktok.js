...
const titoko = `https://bisakah.herokuapp.com/downloader/tiktoknowm?link=${url}`
const tikitoko = `https://bisakah.herokuapp.com/converter/tomp3?url=https://bisakah.herokuapp.com/downloader/tiktoknowm?link=${url}`
const obj = {
	videoInfo: {
		id: ingfo.id,
		desc: ingfo.text,
